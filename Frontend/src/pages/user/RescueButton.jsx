...
export default function RescueButton() {
  ...
  const handleConfirmRescue = async () => {
    ...
    try {
      ...
      alert("🆘 Emergency rescue request sent successfully! Coast Guard has been notified.");
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f]">
      ...
      <div className="px-4 pt-24 pb-12 mx-auto max-w-6xl">
          ...
          <div className="space-y-6">
              ...
              <div className="p-6 border bg-gradient-to-br from-blue-900/20 to-blue-800/10 border-blue-500/30 rounded-2xl backdrop-blur-xl">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div className="p-3 text-center rounded-lg bg-white/5">
                    <div className="mb-1 text-sm text-gray-400">Temperature</div>
                  ...
                  <div className="p-3 text-center rounded-lg bg-white/5">
                    ...
                    <div className="text-lg font-bold text-white">
                      {weatherData.weather?.wind_speed_10m
                        ? `${Math.round(weatherData.weather.wind_speed_10m)} km/h`
                        : "N/A"}
                    </div>
                  </div>
                  <div className="p-3 text-center rounded-lg bg-white/5">
                    <div className="mb-1 text-sm text-gray-400">Wave Height</div>
                    <div className="text-lg font-bold text-white">
                  ...
                  <div className="p-3 text-center rounded-lg bg-white/5">
                    <div className="mb-1 text-sm text-gray-400">Precipitation</div>
                    <div className="text-lg font-bold text-white">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="p-6 border bg-gradient-to-br from-blue-900/20 to-blue-800/10 border-blue-500/30 rounded-2xl backdrop-blur-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border border-yellow-500/30 rounded-lg bg-yellow-900/20">
                    <p className="text-sm text-yellow-200">
                      ⚠️ <strong>Important:</strong> This will send an emergency alert to
                      rescue services with your current location and conditions. Only use in
            ...
            <div className="p-6 border bg-gradient-to-br from-white/5 to-white/0 border-white/10 rounded-2xl backdrop-blur-xl">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex gap-2">
                  ...
                  <span>
                    Stay calm and ensure all crew members are wearing life jackets
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-400">✓</span>
            ...
            <div className="p-6 border bg-gradient-to-br from-orange-900/20 to-red-900/10 border-orange-500/30 rounded-2xl backdrop-blur-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-white/5">
                  <div>
                    <div className="font-semibold text-white">Marine Rescue</div>
                    <div className="text-sm text-gray-400">VHF Radio</div>
                  </div>
                  <div className="text-lg font-bold text-blue-400">Channel 16</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-lg p-7 border-4 border-red-500 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-[0_24px_80px_rgba(239,68,68,0.25)] animate-in zoom-in duration-300">
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-gray-400">
                Auto-sending in <span className="text-xl font-bold text-red-400">{countdown}</span> second{countdown !== 1 ? "s" : ""}...
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-4 font-bold text-white transition-all duration-200 rounded-lg bg-gradient-to-br from-red-500 to-red-600 hover:scale-105 active:scale-95 shadow-xl"
              >
                ⚡ SEND NOW
              </button>
              <button
