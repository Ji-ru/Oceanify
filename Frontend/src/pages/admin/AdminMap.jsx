...
export default function UserPage() {
  ...
  const createWavePopup = (waveData, lat, lng, locationName = "Selected Location") => {
  ...
  const fetchLocationData = async (lat, lng, locationName, dataType) => {
    ...
    try {
      ...
      if (dataType === 'weather' && weatherData?.current) {
        ...
        if (waveData?.current) {
          const wavePopupContent = createWavePopup(waveData, lat, lng, locationName);
